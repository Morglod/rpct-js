...
"use strict";var __awaiter=this&&this.__awaiter||function(e,a,n,t){return new(n||(n=Promise))(function(o,l){function r(e){try{c(t.next(e))}catch(e){l(e)}}function i(e){try{c(t.throw(e))}catch(e){l(e)}}function c(e){e.done?o(e.value):new n(function(a){a(e.value)}).then(r,i)}c((t=t.apply(e,a||[])).next())})},__generator=this&&this.__generator||function(e,a){var n,t,o,l,r={label:0,sent:function(){if(1&o[0])throw o[1];return o[1]},trys:[],ops:[]};return l={next:i(0),throw:i(1),return:i(2)},"function"==typeof Symbol&&(l[Symbol.iterator]=function(){return this}),l;function i(l){return function(i){return function(l){if(n)throw new TypeError("Generator is already executing.");for(;r;)try{if(n=1,t&&(o=2&l[0]?t.return:l[0]?t.throw||((o=t.return)&&o.call(t),0):t.next)&&!(o=o.call(t,l[1])).done)return o;switch(t=0,o&&(l=[2&l[0],o.value]),l[0]){case 0:case 1:o=l;break;case 4:return r.label++,{value:l[1],done:!1};case 5:r.label++,t=l[1],l=[0];continue;case 7:l=r.ops.pop(),r.trys.pop();continue;default:if(!(o=(o=r.trys).length>0&&o[o.length-1])&&(6===l[0]||2===l[0])){r=0;continue}if(3===l[0]&&(!o||l[1]>o[0]&&l[1]<o[3])){r.label=l[1];break}if(6===l[0]&&r.label<o[1]){r.label=o[1],o=l;break}if(o&&r.label<o[2]){r.label=o[2],r.ops.push(l);break}o[2]&&r.ops.pop(),r.trys.pop();continue}l=a.call(e,r)}catch(e){l=[6,e],t=0}finally{n=o=0}if(5&l[0])throw l[1];return{value:l[0]?l[1]:void 0,done:!0}}([l,i])}}};Object.defineProperty(exports,"__esModule",{value:!0});var config_1=require("./config"),Api=function(){return function(e,a,n,t){var o=this;void 0===n&&(n=config_1.DefaultConfig),void 0===t&&(t=""),this.debugName=t,this.handleRemoteCall=function(e){o.config.debug&&console.log("Api_"+o.debugName+' handleRemoteCall: "'+JSON.stringify(e)+'"');var a,n=e;if(!n)throw new Error("Api: handleRemoteCall failed, undefined data");if(n.method){if(!o.definition.selfMethods||!o.definition.selfMethods[n.method])return void console.error("method '"+n.method+"' not found");o.config.debug&&console.log("Api_"+o.debugName+' handleRemoteCall: found selfMethod data.method="'+n.method+'"'),a=o.definition.selfMethods[n.method]}else{if(!n.callback)return void console.error("not method & not callback");if(o.config.debug&&console.log("Api_"+o.debugName+' handleRemoteCall: it has a callback call request data.callback="'+n.callback+'"'),!o.callbacks[n.callback])return void console.error("callback '"+n.method+"' not found");o.config.debug&&console.log("Api_"+o.debugName+' handleRemoteCall: found callback="'+n.callback+'"'),a=o.callbacks[n.callback],delete o.callbacks[n.callback]}o.config.debug&&console.log("Api_"+o.debugName+" handleRemoteCall: processing data.args");var t=n.args.map(function(e,a){return e.callback?(o.config.debug&&console.log("Api_"+o.debugName+" handleRemoteCall: callback at "+a+" arg index, returning proxy"),function(){for(var n=[],t=0;t<arguments.length;t++)n[t]=arguments[t];return o.config.debug&&console.log("Api_"+o.debugName+" handleRemoteCall: proxy call for "+a+' arg index, callbackArgs="'+JSON.stringify(n)+'", callback="'+e.callback+'"'),o._call({callback:e.callback,args:n})}):e.value});return o.config.debug&&console.log("Api_"+o.debugName+" handleRemoteCall: invoking func"),a.apply(void 0,t)},this._call=function(e){return __awaiter(o,void 0,void 0,function(){var a,n=this;return __generator(this,function(t){return this.config.debug&&console.log("Api_"+this.debugName+' call: params="'+JSON.stringify(e)+'"'),a={method:e.method,callback:e.callback,args:e.args.map(function(e,a){if("function"==typeof e){var t=""+n.nextUUID();return n.callbacks[t]=e,n.config.debug&&console.log("Api_"+n.debugName+" call: found func arg at "+a+' index, bound a callback as callbackUUID="'+t+'"'),{callback:t}}return{value:e}})},this.config.debug&&console.log("Api_"+this.debugName+" call: sending request to transport"),[2,this.transport.request(a)]})})},this.callMethod=function(e){for(var a=[],n=1;n<arguments.length;n++)a[n-1]=arguments[n];return o._call({method:e,args:a})},this.callbacks={},this.nextUUID=n.uuidGeneratorFactory(),this.definition=e,this.transport=a,this.config=n,a.setRequestHandler(this.handleRemoteCall)}}();exports.Api=Api;

},{"./config":3}],2:[function(require,module,exports){
"use strict";function __export(e){for(var r in e)exports.hasOwnProperty(r)||(exports[r]=e[r])}Object.defineProperty(exports,"__esModule",{value:!0}),__export(require("./api")),__export(require("./config")),__export(require("./duplex-json-stream.transport")),__export(require("./duplex-stream.transport")),__export(require("./stream.transport")),__export(require("./streams")),__export(require("./ticket-list")),__export(require("./utils")),__export(require("./window.stream")),__export(require("tsee"));
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var utils_1=require("./utils");exports.DefaultConfig={version:"0.1.0",debug:!1,uuidGeneratorFactory:utils_1.hyperidUUIDGenerator};

},{"./utils":9}],4:[function(require,module,exports){
(function (Buffer){
"use strict";var __awaiter=this&&this.__awaiter||function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{u(r.next(e))}catch(e){o(e)}}function s(e){try{u(r.throw(e))}catch(e){o(e)}}function u(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}u((r=r.apply(e,t||[])).next())})},__generator=this&&this.__generator||function(e,t){var n,r,i,o,a={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return o={next:s(0),throw:s(1),return:s(2)},"function"==typeof Symbol&&(o[Symbol.iterator]=function(){return this}),o;function s(o){return function(s){return function(o){if(n)throw new TypeError("Generator is already executing.");for(;a;)try{if(n=1,r&&(i=2&o[0]?r.return:o[0]?r.throw||((i=r.return)&&i.call(r),0):r.next)&&!(i=i.call(r,o[1])).done)return i;switch(r=0,i&&(o=[2&o[0],i.value]),o[0]){case 0:case 1:i=o;break;case 4:return a.label++,{value:o[1],done:!1};case 5:a.label++,r=o[1],o=[0];continue;case 7:o=a.ops.pop(),a.trys.pop();continue;default:if(!(i=(i=a.trys).length>0&&i[i.length-1])&&(6===o[0]||2===o[0])){a=0;continue}if(3===o[0]&&(!i||o[1]>i[0]&&o[1]<i[3])){a.label=o[1];break}if(6===o[0]&&a.label<i[1]){a.label=i[1],i=o;break}if(i&&a.label<i[2]){a.label=i[2],a.ops.push(o);break}i[2]&&a.ops.pop(),a.trys.pop();continue}o=t.call(e,a)}catch(e){o=[6,e],r=0}finally{n=i=0}if(5&o[0])throw o[1];return{value:o[0]?o[1]:void 0,done:!0}}([o,s])}}};Object.defineProperty(exports,"__esModule",{value:!0});var config_1=require("./config"),ticket_list_1=require("./ticket-list"),DuplexJsonStreamTransport=function(){function e(e,t,n){var r=this;void 0===t&&(t=config_1.DefaultConfig),void 0===n&&(n=""),this.debugName=n,this.config=config_1.DefaultConfig,this.pending=new ticket_list_1.TicketList,this.setConfig(t),this.stream=e,e.on("data",function(e){return __awaiter(r,void 0,void 0,function(){var t,r,i;return __generator(this,function(o){switch(o.label){case 0:t=e instanceof Buffer?e.toString("utf8"):e instanceof Uint8Array?e.toString():"object"==typeof e?e:""+e,this.config.debug&&console.log("StreamIOTransport_"+n+' received message: "'+t+'"'),r=e;try{"string"==typeof t&&(r=JSON.parse(t))}catch(e){throw e}if("object"!=typeof r)throw new Error("StreamIOTransport_"+n+" wrong message type; should be object");if(!Object.keys(r).includes("uuid"))throw new Error("StreamIOTransport_"+n+" wrong message type; should have uuid");return this.pending.hasUUID(r.uuid)?(this.config.debug&&console.log("StreamIOTransport_"+n+": found pending",r.uuid),this.pending.answer(r.uuid,r,"no uuid check"),[3,3]):[3,1];case 1:return this.config.debug&&console.log("StreamIOTransport_"+n+": forEach requestHandler"),[4,this.requestHandler(r.data)];case 2:i=o.sent(),this.stream.write(JSON.stringify({uuid:r.uuid,data:i})),o.label=3;case 3:return[2]}})})})}return e.prototype.request=function(e){var t={uuid:this.pending.nextUUID(),data:e};this.config.debug&&console.log("StreamIOTransport_"+this.debugName+": making request",e);var n=this.pending.ask(t.uuid).answer;return this.stream.write(JSON.stringify(t)),n},e.prototype.setRequestHandler=function(e){this.requestHandler=e},e.prototype.getRequestHandler=function(){return this.requestHandler},e.prototype.setConfig=function(e){this.config=e,this.pending.nextUUID=this.config.uuidGeneratorFactory()},e}();exports.DuplexJsonStreamTransport=DuplexJsonStreamTransport;

}).call(this,require("buffer").Buffer)
},{"./config":3,"./ticket-list":8,"buffer":13}],5:[function(require,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(e,t,n,r){return new(n||(n=Promise))(function(i,o){function a(e){try{u(r.next(e))}catch(e){o(e)}}function s(e){try{u(r.throw(e))}catch(e){o(e)}}function u(e){e.done?i(e.value):new n(function(t){t(e.value)}).then(a,s)}u((r=r.apply(e,t||[])).next())})},__generator=this&&this.__generator||function(e,t){var n,r,i,o,a={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return o={next:s(0),throw:s(1),return:s(2)},"function"==typeof Symbol&&(o[Symbol.iterator]=function(){return this}),o;function s(o){return function(s){return function(o){if(n)throw new TypeError("Generator is already executing.");for(;a;)try{if(n=1,r&&(i=2&o[0]?r.return:o[0]?r.throw||((i=r.return)&&i.call(r),0):r.next)&&!(i=i.call(r,o[1])).done)return i;switch(r=0,i&&(o=[2&o[0],i.value]),o[0]){case 0:case 1:i=o;break;case 4:return a.label++,{value:o[1],done:!1};case 5:a.label++,r=o[1],o=[0];continue;case 7:o=a.ops.pop(),a.trys.pop();continue;default:if(!(i=(i=a.trys).length>0&&i[i.length-1])&&(6===o[0]||2===o[0])){a=0;continue}if(3===o[0]&&(!i||o[1]>i[0]&&o[1]<i[3])){a.label=o[1];break}if(6===o[0]&&a.label<i[1]){a.label=i[1],i=o;break}if(i&&a.label<i[2]){a.label=i[2],a.ops.push(o);break}i[2]&&a.ops.pop(),a.trys.pop();continue}o=t.call(e,a)}catch(e){o=[6,e],r=0}finally{n=i=0}if(5&o[0])throw o[1];return{value:o[0]?o[1]:void 0,done:!0}}([o,s])}}};Object.defineProperty(exports,"__esModule",{value:!0});var config_1=require("./config"),ticket_list_1=require("./ticket-list"),DuplexStreamTransport=function(){function e(e,t,n){var r=this;void 0===t&&(t=config_1.DefaultConfig),void 0===n&&(n=""),this.debugName=n,this.config=config_1.DefaultConfig,this.pending=new ticket_list_1.TicketList,this.setConfig(t),this.stream=e,e.on("data",function(e){return __awaiter(r,void 0,void 0,function(){var t;return __generator(this,function(r){switch(r.label){case 0:if(this.config.debug&&console.log("StreamIOTransport_"+n+' received message: "'+JSON.stringify(e)+'"'),"object"!=typeof e)throw new Error("StreamIOTransport_"+n+" wrong message type");if(!Object.keys(e).includes("uuid"))throw new Error("StreamIOTransport_"+n+" wrong message type");return this.pending.hasUUID(e.uuid)?(this.config.debug&&console.log("StreamIOTransport_"+n+": found pending",e.uuid),this.pending.answer(e.uuid,e,"no uuid check"),[3,3]):[3,1];case 1:return this.config.debug&&console.log("StreamIOTransport_"+n+": forEach requestHandler"),[4,this.requestHandler(e.data)];case 2:t=r.sent(),this.stream.write({uuid:e.uuid,data:t}),r.label=3;case 3:return[2]}})})})}return e.prototype.request=function(e){var t={uuid:this.pending.nextUUID(),data:e};this.config.debug&&console.log("StreamIOTransport_"+this.debugName+": making request",e);var n=this.pending.ask(t.uuid).answer;return this.stream.write(t),n},e.prototype.setRequestHandler=function(e){this.requestHandler=e},e.prototype.getRequestHandler=function(){return this.requestHandler},e.prototype.setConfig=function(e){this.config=e,this.pending.nextUUID=this.config.uuidGeneratorFactory()},e}();exports.DuplexStreamTransport=DuplexStreamTransport;

},{"./config":3,"./ticket-list":8}],6:[function(require,module,exports){
"use strict";var __awaiter=this&&this.__awaiter||function(t,e,n,r){return new(n||(n=Promise))(function(i,a){function o(t){try{u(r.next(t))}catch(t){a(t)}}function s(t){try{u(r.throw(t))}catch(t){a(t)}}function u(t){t.done?i(t.value):new n(function(e){e(t.value)}).then(o,s)}u((r=r.apply(t,e||[])).next())})},__generator=this&&this.__generator||function(t,e){var n,r,i,a,o={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return a={next:s(0),throw:s(1),return:s(2)},"function"==typeof Symbol&&(a[Symbol.iterator]=function(){return this}),a;function s(a){return function(s){return function(a){if(n)throw new TypeError("Generator is already executing.");for(;o;)try{if(n=1,r&&(i=2&a[0]?r.return:a[0]?r.throw||((i=r.return)&&i.call(r),0):r.next)&&!(i=i.call(r,a[1])).done)return i;switch(r=0,i&&(a=[2&a[0],i.value]),a[0]){case 0:case 1:i=a;break;case 4:return o.label++,{value:a[1],done:!1};case 5:o.label++,r=a[1],a=[0];continue;case 7:a=o.ops.pop(),o.trys.pop();continue;default:if(!(i=(i=o.trys).length>0&&i[i.length-1])&&(6===a[0]||2===a[0])){o=0;continue}if(3===a[0]&&(!i||a[1]>i[0]&&a[1]<i[3])){o.label=a[1];break}if(6===a[0]&&o.label<i[1]){o.label=i[1],i=a;break}if(i&&o.label<i[2]){o.label=i[2],o.ops.push(a);break}i[2]&&o.ops.pop(),o.trys.pop();continue}a=e.call(t,o)}catch(t){a=[6,t],r=0}finally{n=i=0}if(5&a[0])throw a[1];return{value:a[0]?a[1]:void 0,done:!0}}([a,s])}}};Object.defineProperty(exports,"__esModule",{value:!0});var config_1=require("./config"),ticket_list_1=require("./ticket-list"),streams_1=require("./streams"),StreamTransport=function(){function t(t,e,n,r){var i=this;void 0===n&&(n=config_1.DefaultConfig),void 0===r&&(r=""),this.debugName=r,this.config=config_1.DefaultConfig,this.pending=new ticket_list_1.TicketList,this.rstream=streams_1.asReadableStream(t),this.wstream=streams_1.asWritableStream(e),this.setConfig(n),this.rstream.on("data",function(t){return __awaiter(i,void 0,void 0,function(){var e;return __generator(this,function(n){switch(n.label){case 0:if(this.config.debug&&console.log("StreamIOTransport_"+r+' onData: "'+JSON.stringify(t)+'"'),"object"!=typeof t)throw new Error("StreamIOTransport_"+r+" wrong message type");if(!Object.keys(t).includes("uuid"))throw new Error("StreamIOTransport_"+r+" wrong message type");return this.pending.hasUUID(t.uuid)?(this.config.debug&&console.log("StreamIOTransport_"+r+': found pending, answering pending ticket uuid="'+t.uuid+'"'),this.pending.answer(t.uuid,t,"no uuid check"),[3,3]):[3,1];case 1:return this.config.debug&&console.log("StreamIOTransport_"+r+': no pending ticket with this uuid="'+t.uuid+'", calling requestHandler'),[4,this.requestHandler(t.data)];case 2:e=n.sent(),this.config.debug&&console.log("StreamIOTransport_"+r+': requestHandler for uuid="'+t.uuid+'", answered data: "'+JSON.stringify(e)+'"'),this.wstream.write({uuid:t.uuid,data:e}),n.label=3;case 3:return[2]}})})})}return t.prototype.request=function(t){var e=this.pending.nextUUID(),n={uuid:e,data:t};this.config.debug&&console.log("StreamIOTransport_"+this.debugName+': making request with uuid="'+e+'", data="'+JSON.stringify(t)+'", new pending ticket');var r=this.pending.ask(n.uuid).answer;return this.wstream.write(n),r.then(function(t){return t.data})},t.prototype.setRequestHandler=function(t){this.requestHandler=t},t.prototype.getRequestHandler=function(){return this.requestHandler},t.prototype.setConfig=function(t){this.config=t,this.pending.nextUUID=this.config.uuidGeneratorFactory()},t}();exports.StreamTransport=StreamTransport;

},{"./config":3,"./streams":7,"./ticket-list":8}],7:[function(require,module,exports){
"use strict";var __assign=this&&this.__assign||function(){return(__assign=Object.assign||function(e){for(var r,t=1,a=arguments.length;t<a;t++)for(var s in r=arguments[t])Object.prototype.hasOwnProperty.call(r,s)&&(e[s]=r[s]);return e}).apply(this,arguments)},__importStar=this&&this.__importStar||function(e){if(e&&e.__esModule)return e;var r={};if(null!=e)for(var t in e)Object.hasOwnProperty.call(e,t)&&(r[t]=e[t]);return r.default=e,r};Object.defineProperty(exports,"__esModule",{value:!0});var streams=__importStar(require("stream"));function simpleCrossStream(e){void 0===e&&(e={});var r=e.objectMode,t=void 0===r||r,a=e.highWaterMark,s=void 0===a?void 0:a,n=[];return asDuplexStream(new streams.Duplex({objectMode:t,highWaterMark:s,write:function(e,r,t){n.push(e),t&&t()},read:function(){if(0!==n.length){var e=n[n.length-1];n.pop(),this.push(e)}else this.push(void 0)}}))}function asReadableStream(e){return e}function asWritableStream(e){return e}function asDuplexStream(e){return e}function debugStream(e,r){return void 0===r&&(r={objectMode:!0}),new streams.Transform(__assign({},r,{transform:function(r,t,a){var s=e(r,t);s instanceof Promise?s.then(function(e){return a(void 0,e)}).catch(function(e){return a(e)}):a(void 0,r)}}))}exports.simpleCrossStream=simpleCrossStream,exports.asReadableStream=asReadableStream,exports.asWritableStream=asWritableStream,exports.asDuplexStream=asDuplexStream,exports.debugStream=debugStream;

},{"stream":37}],8:[function(require,module,exports){
"use strict";var __extends=this&&this.__extends||function(){var t=function(e,n){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n])})(e,n)};return function(e,n){function i(){this.constructor=e}t(e,n),e.prototype=null===n?Object.create(n):(i.prototype=n.prototype,new i)}}();Object.defineProperty(exports,"__esModule",{value:!0});var TicketListAnswerError=function(t){function e(e,n){var i=t.call(this,e)||this;return i.uuid=n,i}return __extends(e,t),e}(Error);exports.TicketListAnswerError=TicketListAnswerError;var TicketList=function(){function t(){var e,n=this;this.ask=function(t){var e=null===t?n.nextUUID():t,i=new Promise(function(t,i){n.pendingTickets[e]=function(r,o){r||!o?(delete n.pendingTickets[e],t(r)):i(o)}});return{uuid:e,answer:i}},this.answer=function(t,e,i){if(void 0===i&&(i=!1),!i&&!n.hasUUID(t))throw new TicketListAnswerError('no pending ticket for uuid="'+t+'"',t);var r=n.pendingTickets[t];delete n.pendingTickets[t],r(e)},this.pendingTickets={},this.hasUUID=function(t){return t in n.pendingTickets},this.rejectTicket=function(e,i){if(void 0===i&&(i=!1),n.hasUUID(e)){var r=n.pendingTickets[e];if(delete n.pendingTickets[e],"ignore errors"===i)try{r(void 0,t.TICKET_REJECTED)}catch(t){}else r(void 0,t.TICKET_REJECTED)}},this.nextUUID=(e=0,function(){e>=Number.MAX_SAFE_INTEGER-5&&(e=0);do{e++}while(n.hasUUID(e));return e})}return t.TICKET_REJECTED=Symbol("TICKET_REJECTED"),t}();exports.TicketList=TicketList;

},{}],9:[function(require,module,exports){
"use strict";var __importDefault=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0});var hyperid_1=__importDefault(require("hyperid"));function cloneJSON(e){return JSON.parse(JSON.stringify(e))}function simpleUUIDGenerator(){var e=0;return function(){return e>=Number.MAX_SAFE_INTEGER-5&&(e=0),++e}}function hyperidUUIDGenerator(){var e=hyperid_1.default({fixedLength:!0});return function(){return e()}}exports.cloneJSON=cloneJSON,exports.simpleUUIDGenerator=simpleUUIDGenerator,exports.hyperidUUIDGenerator=hyperidUUIDGenerator;

},{"hyperid":16}],10:[function(require,module,exports){
"use strict";var __extends=this&&this.__extends||function(){var t=function(e,r){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var r in e)e.hasOwnProperty(r)&&(t[r]=e[r])})(e,r)};return function(e,r){function a(){this.constructor=e}t(e,r),e.prototype=null===r?Object.create(r):(a.prototype=r.prototype,new a)}}(),__importStar=this&&this.__importStar||function(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var r in t)Object.hasOwnProperty.call(t,r)&&(e[r]=t[r]);return e.default=t,e};Object.defineProperty(exports,"__esModule",{value:!0});var tsee=__importStar(require("tsee"));function defaultWindowStreamDataUnpacker(t){try{var e=JSON.parse(t.data);if("object"==typeof e&&"_$_rpct-window-stream_$_"===e.type&&"payload"in e)return e.payload}catch(t){}return exports.WINDOW_STREAM_DATA_FAIL}function defaultWindowStreamDataPacker(t){var e={type:"_$_rpct-window-stream_$_",payload:t};return JSON.stringify(e)}function createWindowReadStream(t,e){void 0===e&&(e={});var r=createWindowReadStreamHandler(e),a=r.stream,n=r.handler;t.addEventListener("message",n);return{stream:a,disposer:function(){t.removeEventListener("message",n)}}}function createWindowReadStreamHandler(t){void 0===t&&(t={});var e=t.unpack,r=void 0===e?defaultWindowStreamDataUnpacker:e,a=new tsee.EventEmitter;return{stream:a,handler:function(t){var e=r(t);e!==exports.WINDOW_STREAM_DATA_FAIL&&a.emit("data",e)}}}exports.WINDOW_STREAM_DATA_FAIL=Symbol("WINDOW_STREAM_DATA_FAIL"),exports.defaultWindowStreamDataUnpacker=defaultWindowStreamDataUnpacker,exports.defaultWindowStreamDataPacker=defaultWindowStreamDataPacker,exports.createWindowReadStream=createWindowReadStream,exports.createWindowReadStreamHandler=createWindowReadStreamHandler;var WindowWriteStream=function(t){function e(e,r){var a=t.call(this)||this;return a.window=e,a.opts=r,a.packer=r.pack||defaultWindowStreamDataPacker,a.targetOrigin=r.targetOrigin||"*",a}return __extends(e,t),e.prototype.write=function(t,e,r){"function"==typeof e&&(r=e);var a=this.packer(t);return this.window.postMessage(a,this.targetOrigin),r&&r(),!0},e}(tsee.EventEmitter);function createWindowWriteStream(t,e){return void 0===e&&(e={}),new WindowWriteStream(t,e)}exports.WindowWriteStream=WindowWriteStream,exports.createWindowWriteStream=createWindowWriteStream;
...
"use strict";const uuid=require("uuid/v4"),parser=require("uuid-parse"),maxInt=Math.pow(2,31)-1,Buffer=require("buffer").Buffer;function hyperid(e){var r=!1,u=!1;"boolean"==typeof e?r=e:(u=!!(e=e||{}).urlSafe,r=!!e.fixedLength);var a=0;n.uuid=uuid();var d=baseId(n.uuid,u);function n(){var e=r?d+pad(a++):d+a++;return a===maxInt&&(n.uuid=uuid(),d=baseId(n.uuid,u),a=0),e}return n.decode=decode,n}function pad(e){return e<10?"000000000"+e:e<100?"00000000"+e:e<1e3?"0000000"+e:e<1e4?"000000"+e:e<1e5?"00000"+e:e<1e6?"0000"+e:e<1e7?"000"+e:e<1e8?"00"+e:e<1e9?"0"+e:void 0}function baseId(e,r){var u=Buffer.from(parser.parse(e)).toString("base64");return r?u.replace(/\+/g,"_").replace(/\//g,"-").replace(/==$/,"-"):u.replace(/==$/,"/")}function decode(e,r){!!(r=r||{}).urlSafe&&(e=e.replace(/-/g,"/").replace(/_/g,"+"));const u=e.match(/(.*)+\/(\d+)+$/);return u?{uuid:parser.unparse(Buffer.from(u[1]+"==","base64")),count:parseInt(u[2])}:null}module.exports=hyperid,module.exports.decode=decode;
...
"use strict";function asTypedEventEmitter(e){return e}Object.defineProperty(exports,"__esModule",{value:!0}),exports.asTypedEventEmitter=asTypedEventEmitter;var EventEmitter=function(){return function(e){void 0===e&&(e=require("events").EventEmitter);var t=this;this.emit=function(e){for(var n,r=[],i=1;i<arguments.length;i++)r[i-1]=arguments[i];return(n=t.emitter).emit.apply(n,[e].concat(r))},this.on=function(e,n){return t.emitter.on(e,n),t},this.once=function(e,n){return t.emitter.once(e,n),t},this.addListener=function(e,n){return t.emitter.addListener(e,n),t},this.removeListener=function(e,n){return t.emitter.removeListener(e,n),t},this.hasListeners=function(e){return 0!==t.emitter.listenerCount(e)},this.prependListener=function(e,n){return t.emitter.prependListener(e,n),t},this.prependOnceListener=function(e,n){return t.emitter.prependOnceListener(e,n),t},this.off=function(e,n){return t.emitter.off(e,n),t},this.removeAllListeners=function(e){return t.emitter.removeAllListeners(e),t},this.setMaxListeners=function(e){return t.emitter.setMaxListeners(e),t},this.getMaxListeners=function(){return t.emitter.getMaxListeners()},this.listeners=function(e){return t.emitter.listeners(e)},this.rawListeners=function(e){return t.emitter.rawListeners(e)},this.eventNames=function(){return t.emitter.eventNames()},this.listenerCount=function(e){return t.emitter.listenerCount(e)},this.emitter=new e}}();exports.EventEmitter=EventEmitter;
...
"use strict";for(var _byteToHex=[],_hexToByte={},i=0;i<256;i++)_byteToHex[i]=(i+256).toString(16).substr(1),_hexToByte[_byteToHex[i]]=i;function parse(e,r,t){var o=r&&t||0,a=0;for(r=r||[],e.toLowerCase().replace(/[0-9a-f]{2}/g,function(e){a<16&&(r[o+a++]=_hexToByte[e])});a<16;)r[o+a++]=0;return r}function unparse(e,r){var t=r||0,o=_byteToHex;return o[e[t++]]+o[e[t++]]+o[e[t++]]+o[e[t++]]+"-"+o[e[t++]]+o[e[t++]]+"-"+o[e[t++]]+o[e[t++]]+"-"+o[e[t++]]+o[e[t++]]+"-"+o[e[t++]]+o[e[t++]]+o[e[t++]]+o[e[t++]]+o[e[t++]]+o[e[t++]]}module.exports={parse:parse,unparse:unparse};
