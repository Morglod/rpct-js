...
function client() {
    ...
    conn.once('connect', function () { return __awaiter(_this, void 0, void 0, function () {
        var _a, encodeStream, decodeStream, readable, writable, localStreamTransport, localApi;
        var _this = this;
        return __generator(this, function (_b) {
            ...
            localApi.callMethod('ping', function (pong) {
                pong(function (str) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, str + ' world'];
                    });
                }); });
            });
            return [2 /*return*/];
    ...
    return net.createServer(function (socket) {
        ...
        var remoteApi = new api_1.Api({
            selfMethods: {
                ping: function (pong) {
                    var _this = this;
                    pong(function (ping2) { return __awaiter(_this, void 0, void 0, function () {
                        var r, _a, _b;
