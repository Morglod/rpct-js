...
(function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            localStreamTransport = new stream_transport_1.StreamIOTransport(session, undefined, 'local');
            localApi = new api_1.Api({}, localStreamTransport);
            remoteStreamTransport = new stream_transport_1.StreamIOTransport(session, undefined, 'remote');
