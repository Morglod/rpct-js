                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    localStreamTransport = new duplex_json_stream_transport_1.DuplexJsonStreamTransport(streams_1.asDuplexStream(chain), undefined, 'local');
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    var srv = net.createServer(function (socket) {
                        ...
                        var remoteStreamTransport = new duplex_json_stream_transport_1.DuplexJsonStreamTransport(streams_1.asDuplexStream(chain), undefined, 'remote');
