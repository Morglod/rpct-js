...
exports.appendCallbackOptions = (func, opts) => {
    return object_options_1.setObjectOptions(func, exports.CALLBACK_OPTIONS_SYMBOL, Object.assign({}, object_options_1.getObjectOptions(func, exports.CALLBACK_OPTIONS_SYMBOL, exports.defaultCallbackOptions), opts));
};
