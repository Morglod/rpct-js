...
var StreamIOTransport = /** @class */ (function () {
    function StreamIOTransport(stream, config, debugName) {
        var _this = this;
    ...
    StreamIOTransport.prototype.request = function (data) {
    ...
    StreamIOTransport.prototype.setRequestHandler = function (handler) {
        this.requestHandler = handler;
    };
    StreamIOTransport.prototype.getRequestHandler = function () {
        return this.requestHandler;
    };
    StreamIOTransport.prototype.setConfig = function (config) {
        this.config = config;
        this.pending.nextUUID = this.config.uuidGeneratorFactory();
    };
    return StreamIOTransport;
}());
exports.StreamIOTransport = StreamIOTransport;
