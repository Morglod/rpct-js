...
function simpleCrossStream() {
    ...
    a.target = b;
    return {
        ar: stream_types_1.asReadableStream(a),
        aw: stream_types_1.asWritableStream(a),
        br: stream_types_1.asReadableStream(b),
        bw: stream_types_1.asWritableStream(b),
        a: stream_types_1.asDuplexStream(a),
        b: stream_types_1.asDuplexStream(b),
    };
}
